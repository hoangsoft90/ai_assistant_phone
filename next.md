...
Cập nhật: 2026-09-23 (+07). Nguồn: `.plan/production_roadmap.md`, `.plan/P4-result.md`, `.plan/P5-result.md`, `.plan/P7-result.md`.

## Đang ở đâu

- **Phase hiện tại: P7 — Production Hardening (phần tĩnh xong: audit bảo mật/lỗi, dialog đạo đức, R8 + workflow CI release; signing CHƯA theo chốt user; phần máy thật = nợ K51). Precondition không đạt (chưa từng có phiên thật) ⇒ user waive có ghi rủi ro. Xem `.plan/P7-result.md` + `RELEASE_NOTES.md`.**

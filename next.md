...
- **Phase hiện tại: P3 — Trigger + Output Mode + Offline Nudge Cache, code xong (211/211 test, 7 lỗi/thứ thừa tự tìm khi review đã xử lý), CHƯA commit.** P1C–P1G + P2 + P3 đã code xong; cả chuỗi còn nợ vòng xác minh trên máy thật (K34 P1F, K39 P2, K41/K42 P3; K27 P1E đã xong). Buổi test P1F 2026-09-22 đã xác nhận đường phát TTS đầu-cuối trên máy thật (user nghe rõ) + phát hiện mất tai nghe; nên gộp các lần test máy thật còn lại vào một lượt (P1F rút-mid/TC2/TC3 + P1G emergency + P2 nudge + P3 gesture/3 chế độ/cache offline/tốc độ đọc).
...
- Code xong: P1A, P1B, P1C, P1D, P1E, P1F, P1G, P2, P3; P0/P0.5 xong phần không cần thiết bị.
...
### Buổi test máy thật sắp tới (gộp nhiều nợ vào MỘT lượt — cần APK mới + tai nghe, ~45′)
